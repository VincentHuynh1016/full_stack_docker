...
const UserInterface: React.FC<UserInterfaceProps> = ({ backendName }) => {
  ...
  const deleteUser = async (userId: number) => {
    try {
      ...
      console.log(`${apiUrl}/api/${backendName}/users/${userId}`);
  ...
  return (
    <div
      className={`user-interface ${bgColor} min-h-screen w-full flex flex-col items-center justify-start p-8`}
    >
      <svg
      ...
      >
        <input
          ...
          className="mb-2 w-full p-2 border border-gray-300 rounded bg-white text-gray-800"
        />
        ...
        {users.map((user) => (
          ...
          >
            ...
            <button
              ...
              className={`${btnColor} text-white px-3 py-1 rounded`}
            >
              Delete User
            </button>
          </div>
